...
namespace ir{
	...
	//// ----------------- MatrizPontos -----------------
	int ir::MatrizPontos::fator_mult(int total_jogadas, int acertos){
	...
	void ir::MatrizPontos::inicializa_matriz_pontos(){
		...
		matriz_pontos[12][3] = -2;
		matriz_pontos[12][4] = 1;
		matriz_pontos[12][5] = 1;
		matriz_pontos[12][6] = 2;
		matriz_pontos[12][7] = 6;
		matriz_pontos[12][8] = 15;
		matriz_pontos[12][9] = 25;
		matriz_pontos[12][10] = 180;
		matriz_pontos[12][11] = 1000;
		matriz_pontos[12][12] = 3000;

		matriz_pontos[13][0] = 0;
		matriz_pontos[13][1] = 0;
		matriz_pontos[13][2] = 0;
		matriz_pontos[13][3] = -2;
		matriz_pontos[13][4] = -2;
		...
		matriz_pontos[14][3] = -2;
		matriz_pontos[14][4] = -2;
		...
		matriz_pontos[15][3] = -2;
		matriz_pontos[15][4] = -2;
